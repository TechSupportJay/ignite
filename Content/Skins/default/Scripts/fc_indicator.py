...
def create(self):
    ...
    self.fc_indicator.set_property("position", [1280/2, -50])
    self.fc_indicator.set_property("text_align", "center")
    self.fc_indicator.set_property("font", f"{skin_dir}/Fonts/default.ttf")
    self.fc_indicator.set_property("font_size", 64)

    camera.do_tween("fc_move", self.fc_indicator, "position:y", 10, 1, "back", "out")
